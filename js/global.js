...
$(function() {
	...
	_functions.scrollCall = function(){
		...
		if(winScr>700) $('header').addClass('scrolled');
		else $('header').removeClass('scrolled');

		if(winScr>80) $('#hhh').addClass('on');
		else $('#hhh').removeClass('on');

		if(winScr>700) $('#niket1').addClass('on');
		else $('#niket1').removeClass('on');

		if(winScr>850) $('#niket2').addClass('on');
		else $('#niket2').removeClass('on');

		if(winScr>950) $('#niket3').addClass('on');
		else $('#niket3').removeClass('on');

		if(winScr>1100) $('#gbeovhs').addClass('on');
		else $('#gbeovhs').removeClass('on');

		if(winScr>1300) $('#gbeovhs2').addClass('on');
		else $('#gbeovhs2').removeClass('on');

		if(winScr>2300) $('#gbeovhs3').addClass('on');
		else $('#gbeovhs3').removeClass('on');

		if(winScr>3000) $('#vorzlwl').addClass('on');
		else $('#vorzlwl').removeClass('on');

		if(winScr>2400) $('#hh').addClass('on');
		else $('#hh').removeClass('on');

		if(winScr>1600) $('#gbeovhs4').addClass('on');
		else $('#gbeovhs4').removeClass('on');		

		if(winScr>2000) $('#gbeovhs5').addClass('on');
		else $('#gbeovhs5').removeClass('on');	

		if(winScr>2800) $('#gbeovhs6').addClass('on');
		else $('#gbeovhs6').removeClass('on');	

		if(winScr>800) $('#gbeovhs8').addClass('on');
		else $('#gbeovhs8').removeClass('on');	
